...
public class CanvasApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Button[] basicArr = {undo, redo, clear, save, open};
        ...
        btns.getChildren().addAll(drowbtn, rubberbtn, clear, linebtn, rectbtn, circlebtn, elpslebtn,
        ...
        open.setOnAction((e)->{
            ...
            FileChooser.ExtensionFilter extFilter = new FileChooser.ExtensionFilter("Image files (*.png), (*.jpg)", "*.png", "*.jpg", "*.jpeg");
